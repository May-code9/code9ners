...
<div class="wrapper-content">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-16">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('siteFeature.store') }}">
          {{ csrf_field() }}
          <div class="card">

            <div class="card-body">
              <h5 class="m-0"> Add Website Feature</h5>
              <hr>
                  ...
                  <div class="row ">
                    <div class="col-lg-8 col-md-8">
                      <div class="form-group">
                        ...
                        <input id="website_feature" name="website_feature" type="text" class="form-control" placeholder="Add Website Feature" required/>
                    ...
                    <div class="col-lg-4 col-md-4">
                      <div class="form-group">
                        <label>Cost</label>
                        <input id="feature_cost" name="feature_cost" type="text" class="form-control" placeholder="Add Feature Cost" required/>
